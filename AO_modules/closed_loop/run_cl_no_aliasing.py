# -*- coding: utf-8 -*-
"""
Created on Mon Nov 16 15:30:44 2020
...
def run_cl_no_aliasing(param,obj):
...
#%%   
    ...
    for i_loop in range(nLoop):
        ...
        fitting_OPD,corr_OPD,c   = getFittingError(atm.OPD*obj.tel.pupil,obj.projector,obj.basis, display = False)
        
        # Remove  fitting error 
        obj.tel.OPD = corr_OPD
        # save phase variance
