...
def load_oopao():
    ...
    if counter == n_max:
        raise RuntimeError('The OOPAO repository could not be found. Make sure that your script is located in a sub-folder of the OOPAO repository!')
