...
def initializeParameterFile():
    ...
    param['nSubaperture'         ] = 70                                             # number of PWFS subaperture along the telescope diameter
...
#    param['m1_reflectivityy'][(np.random.rand(param['nMissingSegments'])*797).astype(int)] = 0.# reflectivity of the missing segment set to 0
    ...
    param['opticalBand'          ] = 'K'                                            # optical band of the guide star see Source.py for the definition of the optical bands
